...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'tobi_bud_d3208b0fcf6bac977553_20190103093220_archive.zip';
	const ARCHIVE_SIZE		 = '54573113';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd3208b0-03093220';
	const VERSION			 = '1.3.2';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.2==');
		self::log('----------------------------------------------------');
